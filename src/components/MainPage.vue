...
<template>
  ...
  <div id="home" class="relative pt-[120px] md:pt-[130px] lg:pt-[160px] bg-primary">
    <div class="container flex items-center  ">
      <div class="flex text-center pl-[62px]">
        <div class=" px-4">
          <div class="
                hero-content
                text-left
      ...
      <div class="pb-8 wow fadeInUp pl-[62px] ">
            ...
            <div class="
              ...
              <div class="text-center">
                <div class="relative inline-block z-10">
                  <img src="/src/assets/images/about/about-image.svg" alt="image" class="mx-auto lg:ml-auto" />
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="flex flex-wrap -mx-4">
        <div class="w-full px-4">
          <div class="text-center mx-auto mb-[60px] max-w-[620px]">
            <span class="font-semibold text-lg text-primary mb-2 block text-2xl">
              開始協作
            </span>
            <h2 class="
                  font-bold
      ...
      <div class="flex flex-wrap">
        <div class="w-full mx-4">
          <div class="text-center mx-auto mb-[60px] lg:mb-20 max-w-[620px]">
            <span class="font-semibold text-lg text-primary text-2xl mb-2 block">
              專案分享社群
            </span>
            <h2 class="
                  font-bold
  ...
  <!-- ====== 店家 Start ====== -->
  <section id="shop" class="py-9 md:py-[120px] relative">
    <div class="
          absolute
          z-[-1]
          w-full
          ...
          left-0
        "></div>
    <div class="container px-4 wow fadeInUp">
      <div class="flex flex-wrap items-center -mx-4">
        <div class="px-4 w-full lg:w-7/12 xl:w-8/12">
          <div class="ud-contact-content-wrapper">
            <div class="ud-contact-title mb-12 lg:mb-[150px] ">
              <span class="text-2xl text-dark font-semibold text-base mb-5">
                合作店家
              </span>
              <h2 class="text-[35px] font-semibold mb-5">
                瀏覽與我們合作的店家們
              </h2>
              <h2 class="text-body-color text-2xl font-medium">
                不必再額外花時間尋找，直接從我們的店家列表中快速地挑選並聯絡看中的店家
              </h2>
            </div>

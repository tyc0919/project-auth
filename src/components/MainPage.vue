...
<template>
    ...
    <div id="home" class="relative pt-[120px] md:pt-[130px] lg:pt-[160px] bg-primary">
        <div class="container top-container">
            <div class="text-center lg:pl-[62px]">
                <div class="px-4">
                    <div class="hero-content text-left max-w-[780px] mx-auto wow fadeInUp" data-wow-delay=".2s">
                        <h1
                            class="text-white font-bold text-3xl sm:text-3xl md:text-[45px] leading-snug sm:leading-snug md:leading-snug mb-8 sm:mb-6 text-center md:text-left items-center"
                        >
                            ACE
                        </h1>
                        <p
    ...
    <!-- ====== 登入/註冊 Start -->
    <section id="sign" class="pt-20 lg:pt-[60px] pb-20 lg:pb-[120px] bg-[#f3f4fe]">
        <div class="container">
            <div class="wow fadeInUp" data-wow-delay=".2s" style="background-color: white">
                <div class="flex flex-wrap -mx-4">
                    <div class="w-full px-4">
                        <div class="lg:flex items-center justify-between border overflow-hidden">
                            <div
                                class="lg:max-w-[565px] xl:max-w-[640px] w-full py-6 px-7 sm:px-12 md:p-16 lg:py-9 lg:px-16 xl:p-[70px]"
                            >
                                <h2
                                ...
                                <router-link
                                    to="/signup"
                                    class="text-xl inline-flex items-center justify-center py-4 px-6 rounded text-white bg-primary text-base flex flex-wrap font-medium hover:bg-opacity-90 hover:shadow-lg transition duration-300 ease-in-out"
                                >
                                    開始使用
                                </router-link>
                            </div>
    ...
    <!-- ====== 協作 Start -->
    <section id="project" class="pt-20 lg:pt-[120px] pb-10 lg:pb-20">
        <div class="container">
            <div class="flex flex-wrap -mx-4">
                <div class="w-full px-4">
            ...
            <div class="flex flex-wrap justify-center -mx-4">
                <div class="w-full sm:w-1/2 lg:w-1/4 px-4">
                    <div class="mb-10 wow fadeInUp" data-wow-delay=".1s">
                        <div class="relative w-[170px] h-170px] rounded-full z-10 mx-auto mb-6">
                            <img src="/src/assets/images/team/team-01.png" alt="image" class="w-full rounded-full" />
                        ...
                        <div class="text-center">
                            <h4 class="font-medium text-lg text-dark mb-2">Adveen Desuza</h4>
                            <p class="font-medium text-sm text-body-color mb-5">UI Designer</p>
                            <div class="flex items-center justify-center">
                                <a
                                    href="javascript:void(0)"
                                    class="text-[#cdced6] hover:text-primary w-8 h-8 mx-2 flex items-center justify-center"
                                >
                ...
                <div class="w-full sm:w-1/2 lg:w-1/4 px-4">
                    <div class="mb-10 wow fadeInUp" data-wow-delay=".15s">
                        <div class="relative w-[170px] h-170px] rounded-full z-10 mx-auto mb-6">
                            <img src="/src/assets/images/team/team-02.png" alt="image" class="w-full rounded-full" />
                            <span class="absolute top-0 left-0 z-[-1]">
                                <svg
                                    width="71"
                                    height="82"
                        ...
                        <div class="text-center">
                            ...
                            <p class="font-medium text-sm text-body-color mb-5">Product Designer</p>
                            <div class="flex items-center justify-center">
                                <a
                                    href="javascript:void(0)"
                                    class="text-[#cdced6] hover:text-primary w-8 h-8 mx-2 flex items-center justify-center"
                ...
                <div class="w-full sm:w-1/2 lg:w-1/4 px-4">
                    <div class="mb-10 wow fadeInUp" data-wow-delay=".2s">
                        <div class="relative w-[170px] h-170px] rounded-full z-10 mx-auto mb-6">
                            <img src="/src/assets/images/team/team-03.png" alt="image" class="w-full rounded-full" />
                            <span class="absolute top-0 left-0 z-[-1]">
                                <svg
                                    width="71"
                                    height="82"
                        ...
                        <div class="text-center">
                            <h4 class="font-medium text-lg text-dark mb-2">Andrieo Gloree</h4>
                            <p class="font-medium text-sm text-body-color mb-5">App Developer</p>
                            <div class="flex items-center justify-center">
                                <a
                                    href="javascript:void(0)"
                                    class="text-[#cdced6] hover:text-primary w-8 h-8 mx-2 flex items-center justify-center"
                ...
                <div class="w-full sm:w-1/2 lg:w-1/4 px-4">
                    <div class="mb-10 wow fadeInUp" data-wow-delay=".25s">
                        ...
                        <div class="text-center">
                            <h4 class="font-medium text-lg text-dark mb-2">Jackie Sanders</h4>
                            <p class="font-medium text-sm text-body-color mb-5">Content Writer</p>
                            <div class="flex items-center justify-center">
                                <a
                                    href="javascript:void(0)"
                                    class="text-[#cdced6] hover:text-primary w-8 h-8 mx-2 flex items-center justify-center"
    ...
    <!-- ====== 社群 Start ====== -->
    <section id="community" class="pt-20 md:pt-[120px]">
            ...
            <div class="flex flex-wrap">
                <div class="w-full md:w-1/2 lg:w-1/3 px-4">
                    <div
                        ...
                        style="background-color: #fffdfdb8"
                        data-wow-delay=".1s"
                    >
                        ...
                        <div class="ud-testimonial-content mb-6">
                            <p class="text-base tracking-wide text-body-color">超讚的企劃!</p>
                        </div>
                        <div class="ud-testimonial-info flex items-center">
                            <div class="ud-testimonial-image w-[50px] h-[50px] rounded-full overflow-hidden mr-5S">
                                <img src="/src/assets/images/testimonials/author-01.png" alt="author" />
                            </div>
                            <div class="ud-testimonial-meta">
                                <h4 class="text-sm font-semibold">王曉明</h4>
              ...
              "
                    >
                        ...
                        <div class="ud-testimonial-content mb-6">
                            <p class="text-base tracking-wide text-body-color">解說的非常詳細，很適合新手。</p>
                        </div>
                        <div class="ud-testimonial-info flex items-center">
                            <div class="ud-testimonial-image w-[50px] h-[50px] rounded-full overflow-hidden mr-5">
                                <img src="/src/assets/images/testimonials/author-02.png" alt="author" />
                            </div>
                            <div class="ud-testimonial-meta">
                                <h4 class="text-sm font-semibold">張三</h4>
              ...
              "
                    >
                        ...
                        <div class="ud-testimonial-content mb-6">
                            <p class="text-base tracking-wide text-body-color">非常推薦!!!</p>
                        </div>
                        <div class="ud-testimonial-info flex items-center">
                            <div class="ud-testimonial-image w-[50px] h-[50px] rounded-full overflow-hidden mr-5">
                                <img src="/src/assets/images/testimonials/author-03.png" alt="author" />
                            </div>
                            <div class="ud-testimonial-meta">

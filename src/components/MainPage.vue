...
<template>
   ...
   <!-- ====== 首頁 Start -->
    ...
    <section
      id="sign"
      class="pt-20 lg:pt-[60px] pb-20 lg:pb-[120px] bg-[#f3f4fe]"
    >
      <div class="container">
          ...
          <div class="px-4 w-full lg:w-7/12 xl:w-8/12">
            <div class="ud-contact-content-wrapper">
              <div class="ud-contact-title mb-12 lg:mb-[150px] ">
                <span class="text-3xl text-dark font-semibold text-base mb-5">
                  合作店家
                </span>
                <h2 class="text-xl sm:text-[26px] font-semibold mb-5">
                  瀏覽與我們合作的店家們
                </h2>
                <h2 class="text-lg text-body-color md:text-2xl font-medium">
